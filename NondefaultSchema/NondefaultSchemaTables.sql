/* Chloe Jaiswal
4/16/2022
Script to create tables for non-default schema
*/

CREATE TABLE Soccer_League.TEAM (
...
CREATE TABLE Soccer_League.ATHLETE (
...
CREATE TABLE Soccer_League.TEAM_ROSTER (
	TEAM_ID INT NOT NULL,
	ATHLETE_ID INT NOT NULL,
...
CREATE TABLE Soccer_League.[STATS] (
	ATHLETE_ID INT NOT NULL,
...
CREATE TABLE Soccer_League.SEASON_GAMES (
...
CREATE TABLE Soccer_League.ATHLETE_GAME_STATS (
	ATHLETE_ID INT NOT NULL,
	GAME_ID INT NOT NULL,
